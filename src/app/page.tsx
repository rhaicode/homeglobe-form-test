    ...
    <main className='bg-lavender relative h-screen'>
      <div className='h-full sm:flex sm:items-center sm:justify-center sm:overflow-hidden'>
        <div className='pt-12 sm:pt-0'>
          <Card className='relative z-20 mx-auto px-4 py-6 sm:mx-0 sm:w-[438px] sm:h-[562px]'>
            <Image src={iconHomeGlobe}
              width={177.44}
              height={28}
              alt="Homeglobe" />
            <span className='text-rich-black text-xl font-bold block my-4'>Find places to stay anywhere</span>
